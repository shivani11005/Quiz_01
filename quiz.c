...
int main(){
  ...
  if (i==7){
    ...
    if (ans1==2){
      ...
      point1 = 5;
      printf("Your have scored %d points\n\n", point1);
    }
    else {
      printf("Wrong answer\n");
      point01 = 0;
    ...
    printf("3)First computer virus is knowns as?\n\n");
    printf("1) Rabbit\n");
    ...
    printf("You have scored %d points\n", point3);
      ...
      printf("Wrong answer!\n");
      point03 = 0;
      printf("You have scroed %d points\n\n", point03);
      /* code */
    }

    printf("4)Firewell in computer is used for?\n\n");
    printf("1) Security\n");
    printf("2) Data Transmission\n");
    printf("3) Monitoring\n");
    printf("4) Authenciation\n");
